...
parser.add_argument("--model_dir", type=str, default="/GFNet/ckpt/GFNet_X8_R.pth", help="path of model")
parser.add_argument("--results_dir", type=str, default='GFNet/results', help="root dir of results")

opt = parser.parse_args()

net = GFNet(num_feats=opt.num_feats, kernel_size=3, scale=opt.scale)
